(() => {
  var e = {
    ...
    purchase: {
      ...
      data: () => {
        ...
        const n = 0 < e.length ? e[0].ga4_ecommerce : void 0;
        return {
          transactionId: n.transaction_id,
          totalAmount: Number.parseInt(n.value),
          items: n.items.map((e) => ({
            itemId: e.item_id,
    ...
    cart: {
      ...
      data: () => {
        ...
        const n = 0 < e.length ? e[0].ga4_ecommerce : void 0;
        return {
          totalAmount: "" !== n.value ? Number.parseInt(n.value) : 0,
          items: n.items.map((e) => {
  ...
  !(async function (e) {
    var { user: e, purchase: n, login: t, cart: r } = e;
    void 0 !== e && d(e),
      void 0 !== n && c(n),
      void 0 !== r && o(r),
      void 0 !== t && a(t);
